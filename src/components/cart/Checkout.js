        ...
        >
          <div className="offcanvas-header bg-white">
            <div className="offcanvas-logo">
              <Link className="offcanvas-logo__logo" href="#">
              ...
              <ul className="offcanvas-menu">
                        ...
                        <div className="row">
                          <div className="col-xl-3">
                            <div className="menu-content-list">
                              ...
                              >
                                Main Demo <span className="badge hot">Hot</span>
                              </Link>
                              <Link
                                href="index-course-hub.html"
                                className="menu-content-list__link"
                              >
                                Course Hub
                              </Link>
                              <Link
                                href="index-online-academy.html"
                                className="menu-content-list__link"
                              >
                                Online Academy{" "}
                              ...
                              <Link
                                href="index-education-center.html"
                                className="menu-content-list__link"
                              >
                                Education Center{" "}
                                <span className="badge hot">Hot</span>
                          ...
                          <div className="col-xl-3">
                            <div className="menu-content-list">
                              <Link
                                href="index-language-academic.html"
                                className="menu-content-list__link"
                              >
                                Language Academic
                              </Link>
                              <Link
                                href="index-single-instructor.html"
                                className="menu-content-list__link"
                              >
                                Single Instructor
                              </Link>
                              ...
                              <Link
                                href="index-online-art.html"
                                className="menu-content-list__link"
                              >
                                Online Art <span className="badge new">New</span>
                              </Link>
                            </div>
                          </div>
                          <div className="col-xl-6">
                            <div
                              className="menu-content-banner"
                              style={megaMenu}
                            >
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link href="course-grid-01.html">
                        <span>Grid Basic Layout</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="course-grid-02.html">
                        <span>Grid Modern Layout</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="course-grid-left-sidebar.html">
                        <span>Grid Left Sidebar</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="course-grid-right-sidebar.html">
                        <span>Grid Right Sidebar</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="course-list.html">
                        <span>List Basic Layout</span>
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="course-category.html">
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        <li>
                          <Link href="course-single-layout-01.html">
                            <span>Layout 01</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="course-single-layout-02.html">
                            <span>Layout 02</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="course-single-layout-03.html">
                            <span>Layout 03</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="course-single-layout-04.html">
                            <span>Layout 04</span>
                          </Link>
                        </li>
                      </ul>
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link href="blog-grid-01.html">
                        <span>Grid Basic Layout</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-grid-02.html">
                        <span>Grid Wide</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-grid-left-sidebar.html">
                        <span>Grid Left Sidebar</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-grid-right-sidebar.html">
                        <span>Grid Right Sidebar</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-list-style-01.html">
                        <span>List Layout 01</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-list-style-02.html">
                        <span>List Layout 02</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="#">
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link href="become-an-instructor.html">
                        <span>Become an Instructor</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="instructors.html">
                        <span>Instructor</span>
                      </Link>
                      <ul className="sub-menu">
                        <li>
                          <Link href="dashboard-my-courses.html">
                            <span>My Courses</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-announcement.html">
                            <span>Announcements</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-withdraw.html">
                            <span>Withdrawals</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-quiz-attempts.html">
                            <span>Quiz Attempts</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-question-answer.html">
                            <span>Question & Answer</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-assignments.html">
                            <span>Assignments</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-students.html">
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link href="dashboard-student-index.html">
                            <span>Dashboard Student</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-profile.html">
                            <span>My Profile</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-all-course.html">
                            <span>Enrolled Courses</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-wishlist.html">
                            <span>Wishlist</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-reviews.html">
                            <span>Reviews</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-my-quiz-attempts.html">
                            <span>My Quiz Attempts</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-purchase-history.html">
                            <span>Purchase History</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="dashboard-settings.html">
                            <span>Settings</span>
                          </Link>
                        </li>
                      </ul>
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      ...
                      <ul className="sub-menu">
                        <li>
                          <Link href="event-grid-sidebar.html">
                            <span>Event Listing 01</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="event-grid.html">
                            <span>Event Listing 02</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="event-list.html">
                            <span>Event Listing 03</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="event-list-sidebar.html">
                            <span>Event Listing 04</span>
                          </Link>
                        </li>
                        <li>
                          <Link href="#">
                          ...
                          <ul className="sub-menu">
                            <li>
                              <Link href="event-details-layout-01.html">
                                <span>Layout 01</span>
                              </Link>
                            </li>
                            <li>
                              <Link href="event-details-layout-02.html">
                                <span>Layout 02</span>
                              </Link>
                            </li>
                          </ul>
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          ...
                          <ul className="sub-menu">
                            <li>
                              <Link href="shop-single-list-left-sidebar.html">
                                <span>List – Left Sidebar</span>
                              </Link>
                            </li>
                            <li>
                              <Link href="shop-single-list-right-sidebar.html">
                                <span>List – Right Sidebar</span>
                              </Link>
                            </li>
                            <li>
                              <Link href="shop-single-list-no-sidebar.html">
                                <span>List – No Sidebar</span>
                              </Link>
                            </li>
                            <li>
                              <Link href="shop-single-tab-left-sidebar.html">
                                <span>Tabs – Left Sidebar</span>
                              </Link>
                            </li>
                            <li>
                              <Link href="shop-single-tab-right-sidebar.html">
                                <span>Tabs – Right Sidebar</span>
                              </Link>
                            </li>
                            <li>
                              <Link href="shop-single-tab-no-sidebar.html">
                                <span>Tabs – No Sidebar</span>
                              </Link>
                            </li>
                          </ul>
                        </li>
                    ...
                    <li>
                      <Link href="zoom-meetings.html">
                        <span>Zoom Meetings</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="zoom-meetings-single.html">
                        <span>Zoom Meeting Single</span>
                      </Link>
                    </li>
                  </ul>
                </li>
              ...
              <div className="col-lg-7">
                ...
                <div className="checkout-form">
                  ...
                  <div className="checkout-form__details">
                    ...
                    {/* <!-- Checkout Form Input Start --> */}
                    <div className="checkout-form__input form-check mt-4">
                    ...
                    <div className="checkout-form__account mt-4">
                      {/* <!-- Checkout Form Input Start --> */}
                      <div className="checkout-form__input">
                        <label className="form-label">
                    ...
                    <div className="checkout-form__shipping mt-4">
                      <div className="row gy-4">
                        <div className="col-md-6">
                          {/* <!-- Checkout Form Input Start --> */}
                          <div className="checkout-form__input">
                    ...
                    {/* <!-- Checkout Form Input Start --> */}
                    <div className="checkout-form__input mt-4">
                    ...
                    <ul className="checkout-form__payment-methods">
                      <li className="checkout-form__payment-method">
                        <input
                          ...
                          name="payment-method"
                        />
                        <label className="checkout-form__payment-title" for="cash">
                      ...
                      <li className="checkout-form__payment-method">
                        <input
                          ...
                          name="payment-method"
                        />
                        <label className="checkout-form__payment-title" for="bank">
                          <span className="payment-icon">
                            <svg
                              version="1.1"
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <span className="payment-name">Direct bank transfer</span>
                        </label>
                      ...
                      <li className="checkout-form__payment-method">
                        <input
                          ...
                          name="payment-method"
                        />
                        <label className="checkout-form__payment-title" for="check">
                          <span className="payment-icon">
                            <svg
                              version="1.1"
                              xmlns="http://www.w3.org/2000/svg"
                            ...
                            >
                              <path
                                d="M313.583,134.372H87.111c-4.808,0-8.711,3.896-8.711,8.711c0,4.808,3.896,8.711,8.711,8.711h226.472
                                                        c4.808,0,8.711-3.902,8.711-8.711C322.294,138.268,318.391,134.372,313.583,134.372z"
                              ></path>
                              <path
                                d="M272.935,192.442H87.111c-4.808,0-8.711,3.896-8.711,8.711c0,4.808,3.896,8.711,8.711,8.711h185.824
                                                        c4.808,0,8.711-3.903,8.711-8.711C281.645,196.338,277.743,192.442,272.935,192.442z"
                              ></path>
                              <path
                                d="M180.022,250.511H87.111c-4.808,0-8.711,3.896-8.711,8.711c0,4.808,3.902,8.711,8.711,8.711h92.911
                                                        c4.808,0,8.711-3.903,8.711-8.711C188.733,254.409,184.83,250.511,180.022,250.511z"
                              ></path>
                              <path
                                d="M508.611,163.831l-35.771-35.765c-0.749-0.749-1.591-1.324-2.474-1.823V79.206c0-12.775-10.452-23.228-23.228-23.228
                      ...
                      <li className="checkout-form__payment-method">
                        ...
                        >
                          <span className="payment-icon">
                            ...
                            >
                              <path
                                d="M476.166,169.725c-9.687-35.524-34.838-60.946-72.909-73.865c-4.511-26.425-16.475-47.896-35.655-63.87
                              ...
                              ></path>
                              <path
                                d="M111.82,210.263c-5.517-1.126-10.905,2.434-12.032,7.953l-0.97,4.753c-1.126,5.518,2.434,10.905,7.953,12.032
                              ...
                              ></path>
                              <path
                                d="M104.062,248.28c-5.517-1.126-10.905,2.434-12.032,7.953L66.231,382.638c-1.126,5.518,2.434,10.905,7.953,12.032
                      ...
                      <li className="checkout-form__payment-method">
                        <input
                          ...
                          name="payment-method"
                        />
                        <label className="checkout-form__payment-title" for="card">
                          <span className="payment-icon">
                            <svg
                              version="1.1"
                              xmlns="http://www.w3.org/2000/svg"
                        ...
                        <tr className="checkout-order__cart-item">
                          <td className="checkout-order__info">
                            <div className="checkout-order__product">
                              <div className="checkout-order__product-thumbnail">
                                <img
                                  src={"https://htmldemo.net/edumall/edumall/assets/images/product/product-2.png"}
                                  alt="Product"
                                  width="80"
                                  height="80"
                                />
                        ...
                        <tr className="checkout-order__cart-item">
                          <td className="checkout-order__info">
                            <div className="checkout-order__product">
                              <div className="checkout-order__product-thumbnail">
                                <img
                                  src={"https://htmldemo.net/edumall/edumall/assets/images/courses/courses-28.jpg"}
                                  alt="Product"
                                  width="80"
                                  height="80"
                                />
                        ...
                        <tr className="checkout-order__cart-item">
                          <td className="checkout-order__info">
                            <div className="checkout-order__product">
                              <div className="checkout-order__product-thumbnail">
                                <img
                                  src={"https://htmldemo.net/edumall/edumall/assets/images/product/product-3.png"}
                                  alt="Product"
                                  width="80"
                                  height="80"
                                />
                        ...
                        <tr className="checkout-order__cart-item">
                          <td className="checkout-order__info">
                            <div className="checkout-order__product">
                              <div className="checkout-order__product-thumbnail">
                                <img
                                  src={"https://htmldemo.net/edumall/edumall/assets/images/courses/courses-7.jpg"}
                                  alt="Product"
                                  width="80"
                                  height="80"
                                />
                              ...
                              <div className="checkout-order__product-caption">
                                <h3 className="checkout-order__name">
                                  Digital Advertising & Marketing 101: Take The
                                  Complete Guide<span className="quantity">x1</span>
                                </h3>
                              </div>
                            </div>
                          </td>
